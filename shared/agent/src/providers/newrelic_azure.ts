...
import //	AzureDevOpsUser,
"../protocol/agent.protocol";
import { CSNewRelicAzureProviderInfo } from "../protocol/api.protocol";
...
@lspProvider("newrelic_azure")
export class NewRelicAzureProvider extends ThirdPartyIssueProviderBase<
	CSNewRelicAzureProviderInfo
> {
	get displayName() {
		return "New Relic (Azure)";
	}
